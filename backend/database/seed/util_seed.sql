...
('Cavapom'), ('Cavapoo'), ('Cesky Terrier'), ('Chart Polski'), ('Chesapeake Bay Retriever'), ('Chihuahua'), ('Chinese Crested'),
...
('Harrier'), ('Ibizan Hound'), ('Icelandic Sheepdog'), ('Irish Red and White Setter'), ('Irish Setter'),
...
('Kuvasz'), ('Labradoodle'), ('Labrador Retriever'), ('Lacy Dog'), ('Lagotto Romagnolo'), ('Lakeland Terrier'), ('Large
Munsterlander'), ('Lhasa Apso'),
...
('Plott'), ('Pointer'), ('Polish Lowland Sheepdog'), ('Pomapoo'), ('Pomeranian'), ('Pomsky'), ('Poodle'), ('Portuguese Podengo'), ('Portuguese Water Dog'),
('Pug'), ('Pugapoo'), ('Puggle'), ('Puli'), ('Pumi'), ('Pyrenean Shepherd'), ('Rat Terrier'), ('Redbone Coonhound'), ('Rhodesian Ridgeback'),
...
('Yorkipoo'), ('Yorkshire Terrier'), ('Unknown'), ('Large Munsterlander');
